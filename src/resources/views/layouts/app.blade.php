            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        ...
                        <li><a href="{{ url('/register') }}">สมัครสมาชิกเว็บ / ID เกม</a></li>
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                สวัสดี {{ Auth::user()->realname }} <span class="caret"></span>
                            </a>
            ...
            <div class="col-md-3">
                <div class="panel panel-info">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item download"><a href="{{ url('/board/13') }}">ดาวน์โหลดเกม</a></li>
                        <li class="list-group-item"><a href="{{ url('/board') }}">เว็บบอร์ด</a></li>
                        <li class="list-group-item"><a href="{{ url('/board/4') }}">วิธีการเล่น</a></li>
                        <li class="list-group-item"><a href="{{ url('/register') }}">สมัครสมาชิกเว็บ / ID เกม</a></li>
                    </ul>
                </div>
                ...
                <div class="panel panel-info" id="game_info">
					...
					<div class="panel-body">
						<b>Server IP ::</b> mc.ezdev.me<br>
                        <b>เวอร์ชั่น :: </b> 1.11.2<br>
